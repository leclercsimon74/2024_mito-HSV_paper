...
def moving_avg(y, N):
    #smooth a 1D array y on N element with padded edges
...
def get_color(nb, kind, dic=False):
    ...
    original = {'puce':(204/255, 136/255, 153/255),
                'pastel-green':(119/255, 221/255, 119/255),
                'blue-gray':(102/255, 153/255, 204/255),
                'tan':(210/255, 180/255, 140/255),
                'pastel-red':(1, 105/255, 97/255),
                'honeycomb':(234/255, 232/255, 111/255),
                'lilac':(200/255, 162/255, 200/255),
                'celadon':(172/255, 1, 175/255)
                }
